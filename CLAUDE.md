...
- **Confirmed working as of 2026-03-19** (health-check ~17:30 UTC): 10/10 latest runs succeeded (9-12 min each). 24 signals evaluated (7 correct at 24h = 29%, 6 correct at 48h = 35%). exit_hype pattern: 50% at 24h, 55% at 48h (75% excl tainted LINK). buying_fear: 0/10 = 0%. DB stats: 1,056 coins, 45,000 snapshots, 45,968 social signals, 4,587 whale txs (deduped), 252 alerts, 105 wallets, 6,300 trending, 42,235 on-chain. Market mood: 23 (Extreme Fear).
