...
- **Current hit rates (as of 2026-03-26, 32 raw signals evaluated + 7 pending)**: exit_hype: **43%/63%/69%** at 24h/48h/72h (21 signals). excl LINK: **53%/73%/85%**. excl LINK+COMP: **56%/79%/92%**. **Bounce-back pattern confirmed 3/3**: IDs 283/284/285 all wrong at 24h (bounced) but correct at 48h (dropped). buying_fear: **9%/27%/18%** (11 signals). dip_buy: 0 signals. Signal coins: SHIB, 1INCH, ARB, LDO, SAND, COMP, LINK, PEPE, AAVE, + IMX (buying_fear). Dashboard deduplicates by coin+type keeping most recent (ts DESC).
